...
import { getSigmaPath, publicAssetPath } from "./runtime";
...
const assetPaths = {
  logo: publicAssetPath("assets/images/atlas-logo.png"),
  searchIcon: publicAssetPath("assets/icons/search-icon.png"),
  arrowIcon: publicAssetPath("assets/icons/arrow-icon.png"),
  hotspotIcon: publicAssetPath("assets/map/hotspot-icon.png"),
  forest: publicAssetPath("assets/images/news-forest-protection.png"),
  fire: publicAssetPath("assets/images/news-fire-monitoring.png"),
  drone: publicAssetPath("assets/images/news-drone-optimization.png"),
  research: publicAssetPath("assets/images/news-research-development.png"),
  patrol02: publicAssetPath("assets/images/unit-patroli-02.png"),
  patrol03: publicAssetPath("assets/images/unit-patroli-03.png"),
  wildlifeObservation: publicAssetPath("assets/images/wildlife-observation-01.png"),
};
...
async function loadShpData() {
  const response = await fetch(publicAssetPath("assets/data/DataSHP.zip"));
...
function App() {
  ...
  const handleDashboardClick = (dashboard: Dashboard) => {
    if (dashboard.name === "SIGMA" && dashboard.route) {
      window.location.assign(getSigmaPath(dashboard.route));
      return;
    }
    ...
    <main className="atlas-site">
      <header ref={headerRef} className="topbar">
        ...
        <div className="topbar-actions">
          ...
          <button className="login-link" type="button" onClick={() => window.location.assign(getSigmaPath("login"))}>
            Login
          </button>
        </div>
