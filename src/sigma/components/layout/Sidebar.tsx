...
import { publicAssetPath } from '../../../runtime'
...
const primaryItems = [
  ...
  { to: '/patrols', label: 'Patrol Monitoring', icon: ShieldCheck },
  { to: '/assets', label: 'Asset Monitoring', icon: PackageSearch },
  { to: '/visibility', label: 'Visibility', icon: MapPinned },
  { to: '/risk', label: 'Risk & Hotspot', icon: ShieldAlert },
  { to: '/findings', label: 'Findings', icon: ClipboardCheck },
  { to: '/performance', label: 'Performance', icon: Gauge },
  { to: '/reports', label: 'Reports', icon: FileBarChart },
]

const adminItems = [
  { to: '/admin/data-entry', label: 'Data Entry', icon: FileInput },
  { to: '/admin/validation', label: 'Validation Queue', icon: ClipboardCheck },
